...
def makeRequest(request):
    ...
    if request.method == 'POST':
        requestForm = makeRequestForm(request.POST, initial=initialData)
        if requestForm.is_valid():
            ...
            flag = "Form is invalid. Please check your inputs."
    else:
        requestForm = makeRequestForm(initial=initialData)
